...
export default function EditBlogPostPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.tags?.length) return "Minimal satu tag harus ditambahkan";
    return null;
  };
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span>Dibuat:</span>
                  <span>{formData.created_at ? new Date(formData.created_at).toLocaleDateString('id-ID') : '-'}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span>Diperbarui:</span>
                  <span>{formData.updated_at ? new Date(formData.updated_at).toLocaleDateString('id-ID') : '-'}</span>
                </div>
              </CardContent>
            </Card>
          </div>
