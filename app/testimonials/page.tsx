...
export const metadata: Metadata = {
  title: 'Testimoni Klien - Kepercayaan Perusahaan Besar Indonesia',
  description: 'Testimoni dari 500+ perusahaan klien yang telah mempercayai Interior Solutions Indonesia untuk kebutuhan kaca film, sandblast, dan stiker dekoratif.',
  keywords: [
    'testimoni kaca film jakarta',
    'review sandblast indonesia', 
    'klien interior solutions',
    'perusahaan besar indonesia',
    'kepuasan pelanggan',
    'portfolio kaca film',
    'hasil pemasangan sandblast'
  ],
  openGraph: {
    title: 'Testimoni Klien - Kepercayaan Perusahaan Besar Indonesia',
    description: 'Testimoni dari 500+ perusahaan klien yang telah mempercayai Interior Solutions Indonesia untuk kebutuhan kaca film, sandblast, dan stiker dekoratif.',
    url: 'https://interior-solutions-indonesia.com/testimonials',
  },
  alternates: {
    canonical: 'https://interior-solutions-indonesia.com/testimonials',
  },
}
